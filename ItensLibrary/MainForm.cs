...
namespace ItensLibrary
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private UserControlFilmes userControlFilmes = new UserControlFilmes(new Filme());
		private UserControlLivros userControlLivros = new UserControlLivros();
		private UserControlJogos userControlJogos = new UserControlJogos();
		...
		private void btnJogos_Click(object sender, System.EventArgs e)
		{
			panelCanvas.Controls.Clear();
			panelCanvas.Controls.Add(userControlJogos);
		}
	}
}
